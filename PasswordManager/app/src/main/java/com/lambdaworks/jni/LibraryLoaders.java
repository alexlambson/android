...
/**
 * {@code LibraryLoaders} will create the appropriate {@link com.lambdaworks.jni.LibraryLoader} for
...
public class LibraryLoaders {
    /**
     * Create a new {@link com.lambdaworks.jni.LibraryLoader} for the current VM.
     *
     * @return the loader.
     */
