...
public class Tutorial extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // seems very similar to jquery
        mainTextView = (TextView) findViewById(R.id.main_textview);
        mainTextView.setText(getString(R.string.textViewMessage));


        // 2. Access the Button defined in layout XML
        // and listen for it here
        mainButton = (Button) findViewById(R.id.main_button);
        mainButton.setOnClickListener(Tutorial.this);
    ...
    public void displayWelcome() {
        ...
        if (name.length() > 0) {
            ...
            alert.setMessage("Welcome back, " + name + "!");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        setShareIntent(getString(R.string.defaultMessage));
    ...
    public void onItemClick(AdapterView parent, View view, int position, long id) {
        //Log.d("omg android", position + ": " + mJSONAdapter.getItem(position));
        //mNameList.remove(position);
        //mArrayAdapter.notifyDataSetChanged();
        String title = mJSONAdapter.getTitle(position);
        ...
        Log.d("json", mJSONAdapter.toString());
